...
def lon_lat_contour(wd, canv, fig, toolbar, lonf, latf, gridNumEnt, varib, \
    ...
    paramList=[r'B$_r$ (nT)',r'B$_{\theta}$ (nT)',r'B$_{\phi}$ (nT)', \
               ...
               r'NO$^+$ Temperature (K)', \
               r'O Density (cm$^{-3}$)',r'O$_2$ Density (cm$^{-3}$)', \
               r'N$_2$ Density (cm$^{-3}$)',r'H Density (cm$^{-3}$)', \
               r'H$_e$ Density (cm$^{-3}$)',r'NO Density (cm$^{-3}$)', \
               r'N Density (cm$^{-3}$)', \
               r'u$_{O,r}$ (m/s)',r'u$_{O2,r}$ (m/s)', r'u$_{N2,r}$ (m/s)', \
               r'u$_{H,r}$ (m/s)',r'u$_{He,r}$ (m/s)',r'u$_{n,\theta}$ (m/s)', \
               r'u$_{n,\phi}$ (m/s)',r'Neutral Temperature (K)', \
               r'Ion Temperature (K)', r'Electron Density (cm$^{-3}$)', \
               r'Total Neutral Density (cm$^{-3}$)', \
               r'Ion Density (cm$^{-3}$)', r'Neutral Density (cm$^{-3}$)']
